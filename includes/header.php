		...
		<div id="top-header">
			<div class="container">
				...
				<ul class="header-links pull-right">
					<!-- <li><a href="#"><i class="fa fa-inr"></i> VIE</a></li> -->
					<li><?php
						if (isset($_SESSION["makhachhang"])) {
							$sql = "SELECT hotenkh FROM khachhang WHERE makh='$_SESSION[makhachhang]'";
							$query = mysqli_query($conn, $sql);
							$row = mysqli_fetch_array($query);

							echo '
                               <div class="dropdownn">
                                  <a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i> HI ' . $row["hotenkh"] . '</a>
                                  <div class="dropdownn-content">
                                    <a href="" data-toggle="modal" data-target="#profile"><i class="fa fa-user-circle" aria-hidden="true" ></i>Hồ sơ của tôi</a>
